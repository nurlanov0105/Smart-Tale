                                ...
                                [...Array(9)].map((_, idx) =>
                                    <div key={idx} className={styles.chat__left__item}>
                                        <div className={styles.chat__left__item__leftBar}>
                                            <span
                                                className={clsx(styles.card, styles.chat__left__item__leftBar__avatar)}></span>
                                            <div className={styles.chat__left__item__content}>
                                                <span
                                                    className={clsx(styles.card, styles.chat__left__item__content__top)}></span>
                                                <span
                                                    className={clsx(styles.card, styles.chat__left__item__content__bottom)}></span>
                                            </div>
                                            <span
                                                className={clsx(styles.card, styles.chat__left__item__content__image)}></span>
                                        </div>
                                    </div>
                                )
                            }
                ...
                <div className={styles.chat__right}>
                    <div className={styles.chat__header}>
                        <div className={styles.chat__header__top}>
                            <div className={styles.chat__header__leftBar}>
                                ...
                                <div className={styles.chat__left__item__content}>
                                    <span className={clsx(styles.card, styles.chat__header__top__top)}></span>
                                    <span className={clsx(styles.card, styles.chat__header__top__bottom)}></span>
                                </div>
                                <span className={clsx(styles.card, styles.chat__header__top__imageCircle)}></span>
                            </div>
                        </div>
                        <div className={styles.chat__header__bottom}>
                            <div className={styles.chat__header__leftBar}>
                                ...
                                <div className={styles.chat__left__item__content}>
                                    <span className={clsx(styles.card, styles.chat__header__top__line)}></span>
                                </div>
                    ...
                    <div className={styles.chat__bottom}>
                        <div className={styles.chat__chatList}>
                            <span className={clsx(styles.card, styles.chat__user, styles.chat__chatList__big)}></span>
                            <span className={clsx(styles.card, styles.chat__me, styles.chat__chatList__small)}></span>
                            <span
                                className={clsx(styles.card, styles.chat__user, styles.chat__chatList__small)}></span>
                            <span className={clsx(styles.card, styles.chat__me, styles.chat__chatList__big)}></span>
                            <span className={clsx(styles.card, styles.chat__user, styles.chat__chatList__normal)}></span>
                        </div>
