...
export const currencies = [
   ...
   { value: "₽", postValue: "Рубль" },
   { value: "$", postValue: "USD" },
   { value: "€", postValue: "Euro " },
];

export const currenciesMap = {
   Som: { value: "сом", postValue: "Сом" },
   Ruble: { value: "₽", postValue: "Рубль" },
...
export const experienceMap = {
   ...
   "Не имеет значения": { value: "Не имеет значения", postValue: "Не имеет значения" },
   "От 1 года до 3 лет": { value: "От 1 года до 3 лет", postValue: "От 1 года до 3 лет" },
   "От 3 лет до 6 лет": { value: "От 3 лет до 6 лет", postValue: "От 3 лет до 6 лет" },
   "Более 6 лет": { value: "Более 6 лет", postValue: "Более 6 лет" },
};
export const cityMap = {
   "Бишкек": { value: "Бишкек", postValue: "Бишкек" },
   "Ош": { value: "Ош", postValue: "Ош" },
   "Джалал-Абад": { value: "Джалал-Абад", postValue: "Джалал-Абад" },
   "Баткен": { value: "Баткен", postValue: "Баткен" },
   "Нарын": { value: "Нарын", postValue: "Нарын" },
   "Каракол": { value: "Каракол", postValue: "Каракол" },
};
