...
import {
    ...
    ServicesService,
    UserService,
    VacancyFilterStore, VacancyService
} from "@/shared/lib";
import {
    EquipmentQueryKeys,
    OrdersQueryKeys,
    ResumeQueryKeys,
    ServiceQueryKeys,
    UserQueryKeys, VacancyQueryKeys
...
export const useInfinityScroll2 = ({initialData, queryKey, dependencies}: IProps) => {
    ...
    const {
        ...
        queryFn: ({ pageParam = 1  }) => queryFn.queryFn({
            page: pageParam,
            ...dependencies
        }),
        initialPageParam: 1,
    ...
    }, [observerTarget, hasNextPage, fetchNextPage, isLoading, queryFn.nestedData, isFetchingNextPage]); //isFetchingNextPage
