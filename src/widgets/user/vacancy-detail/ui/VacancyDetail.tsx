        ...
        <div className={styles.detail}>
            <div className={styles.detail__left}>
                ...
                <div className={styles.detail__phoneWrapper}>
                    <h3 className={styles.detail__title}>Напишите телефон, чтобы работодатель мог <br/> связаться с вами
                    </h3>
                    <form className={styles.detail__form}>
                        <InputField
                            ...
                            isBordered={true}
                        />
                        <button className={styles.detail__btn} type="submit">Продолжить</button>
                    </form>
                    <p className={styles.detail__conditions}>Нажимая «Продолжить», вы подтверждаете, что ознакомлены,
                        полностью согласны и принимаете условия «<span>Соглашения об оказании услуг по содействию в трудоустройстве</span>»
                    </p>
                </div>
                <div className={styles.detail__info}>
                    <p className={styles.detail__description}>Мы лицензированная IT академия Motion web LLC. Занимаемся
                        обучением IT направлений как оффлайн так и на онлайн формате. Мы в поиске senior
                        Javascript-разработчика способного научить студентов Front-endу и сделать хорошими
                        интернами/джунами</p>
                    <h4 className="h4">Обязанности:</h4>
                    <ul className={styles.detail__list}>
                        <li className={styles.detail__item}>• Преподавать Front-end на Javascripte взрослым по программе
                            обучения
                        </li>
                        <li className={styles.detail__item}>• Проверять и оценивать домашние задания</li>
                        <li className={styles.detail__item}>• Мотивировать и поддерживать учеников в изучении
                            Javascript.
                        </li>
                    </ul>
                    ...
                    <ul className={styles.detail__list}>
                        ...
                        <li className={styles.detail__item}>• опыт преподавания будет большим преимуществом</li>
                    ...
                    <ul className={styles.detail__list}>
                        ...
                        <li className={styles.detail__item}>• График работы: обговаривается по итогу собеседования</li>
