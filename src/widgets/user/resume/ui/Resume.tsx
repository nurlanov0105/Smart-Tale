...
import { cityFilter, graphicsFilter } from "../../createVacancy";
         ...
         <div className={styles.form__row}>
            ...
            <div className={styles.form__block}>
               ...
               <div className={styles.form__salary}>
                  <InputField classname={styles.form__inputBorder} title="от " />
                  <InputField classname={styles.form__inputBorder} title="до " />
               </div>
            </div>
         </div>
