...
import { BoardData } from "@/entities/user/boardCard/model/consts";
import { DragDropContext, DropResult } from "@hello-pangea/dnd";
import { Columns, KanbanOrderProps } from "../model/types";
import { BoardColumn } from "@/features/user/boardColumn";
import styles from "./styles.module.scss";

const initialColumns: Record<Columns, KanbanOrderProps[]> = {
   new: [],
   process: [],
   checking: [],
   sending: [],
...
// import { BoardColumn } from "@/features/user/boardColumn";
// import {useEffect, useState} from "react";
// import {newOrdersList, checkOrdersList, completedOrdersList, postOrdersList, processOrdersList} from "@/entities/user/boardCard/model/consts";
// import {DragDropContext, DropResult} from "@hello-pangea/dnd";
