...
const ActivateOrganizationModal = (props: ModalProps) => {
   const { mutate, isPending } = useActiveOrganization();
   ...
   return (
      <div className={styles.content}>
         <Emojis type="unknown" />
         <h3 className="h3">
            Вы действительно хотите <br /> активировать данную организацию?
         </h3>
         <p className={styles.content__text}>
            Старая организация станет деактивной, <br /> но продолжит функционировать
         </p>
         <div className={styles.content__buttons}>
            <Button onClick={closeModal} classType="btn_bordered">
               Отменить
            </Button>
