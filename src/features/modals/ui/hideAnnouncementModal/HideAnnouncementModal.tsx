...
const HideAnnouncementModal = (props: ModalProps) => {
   const { hideAnnouncement, isError, isLoading } = useHideAnnouncement(props?.type ?? ""); //order | equipment | service
   ...
   return (
      <div className={styles.content}>
         ...
         <p className={styles.content__text}>
            Объявление больше не будет доступно <br /> для просмотра в маркетплейсе
         </p>
