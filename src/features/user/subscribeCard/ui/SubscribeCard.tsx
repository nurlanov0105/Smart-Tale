...
const SubscribeCard: FC<{ type: string }> = ({ type }) => {
   ...
   return (
      <div className={clsx(styles.card, styles[theme])}>
          <div>
              <div className={clsx(styles.card__heading, {
          ...
          <div className={styles.card__bottom}>
              <h5 className={styles.card__gray}>Стоимость: <span className={styles.card__underline}>{data.title}</span>
              </h5>
              <div className={styles.card__price}>
                  <span className={styles.card__discount}>-50%</span>
                  <h4 className={styles.card__cost}>{data.price} ⃀</h4>
                  <span className={styles.card__oldCost}>{data.oldPrice} ⃀</span>
              </div>
