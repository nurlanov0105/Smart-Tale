...
import {MessageItem} from "@/entities/user/messageItem";
                ...
                <>
                    <div className={styles.chat__user}>
                        ...
                        <div className={styles.chat__block}>
                            ...
                            <button className={styles.chat__menu}><Ellipsis/></button>
                        </div>
                    </div>
                    <div className={styles.chat__info}>
                        <div className={styles.chat__info__block}>
                            <Image className={styles.chat__image} src={avatar} alt="avatar" width={30} height={30}/>
                    ...
                    <div className={styles.chat__row}>
                        ...
                        <form className={styles.chat__form}>
                            ...
                            <button className={styles.chat__icon}><SendHorizontal/></button>
                        </form>
                        <input id="file" accept="image/*,.png,.jpg" className="visually-hidden" type="file"/>
                    </div>
                </>
            }
            {
                ...
                <div className={styles.chat__empty}>
                    ...
                    <h3 className="h3">Выберите чат, чтобы начать <br/> разговор</h3>
                </div>
            }
        </div>
    );
