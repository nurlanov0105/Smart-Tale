...
import {EmptyContentProps} from "@/entities/emptyContent/model/types";
                    ...
                    <div className={styles.organization}>
                        <div className={styles.organization__row}>
                            <div>
                                ...
                                <p className={styles.organization__text}>Создайте свою организацию <br/>
                                    и добавьте своих сотрудников</p>
                    ...
                    <div className={styles.organization}>
                        <div className={styles.organization__row}>
                            <div>
                                ...
                                <p className={styles.organization__text}>Пригласите своих сотрудников <br/>
                                    и следите за выполненными задачами</p>
