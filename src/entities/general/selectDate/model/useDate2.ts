...
export const useDate2 = (
    ...
    useEffect(() => {
        ...
        if (day.postValue > daysAmount.length) {
            ...
            setValue("day", { value: daysAmount.length, postValue: daysAmount.length })
        }
        ...
        if (
            ...
            setValue("day", { value: filteredDays[0].value, postValue: filteredDays[0].postValue }); //то устанавливаем самый первый день из нового массива
        }
        ...
        if (isUser && month.value && month.postValue < filteredMonths[0].postValue) { //если текущий месяц меньше чем самый меньший из новых доступных месяцев
            ...
            setValue("month", { value: filteredMonths[0].value, postValue: filteredMonths[0].postValue }); //то устанавливаем первый месяц из нового массива
        }
        // eslint-disable-next-line
    }, [days]);
