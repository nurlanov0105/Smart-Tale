...
import { AuthButtonProps } from "../model/types";
      ...
      <div className={styles.button}>
         {type === "login" && (
            <>
               ...
               <Link href={ROUTES.SIGN_UP} className={styles.button__button}>
                  Зарегистрироваться
               </Link>
            </>
         )}
         {type === "register" && (
            <>
               ...
               <Link href={ROUTES.SIGN_IN} className={styles.button__button}>
                  Войти
               </Link>
            </>
         )}
