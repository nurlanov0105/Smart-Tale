        ...
        <form
            ...
            <div className={styles.form__row}>
                ...
                <div className={styles.form__info}>
                    ...
                    <div>
                        <div className={styles.form__initials}> ФИО:
                ...
                <div className={styles.form__block}>
                    ...
                    <p>{resume?.min_salary}-{resume?.max_salary} {resume?.currency}</p>
                </div>
                <div className={styles.form__block}>
                ...
                <p>{resume?.about_me} Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci architecto
                    corporis debitis eum nobis perspiciatis reprehenderit vel voluptatum. Harum ipsam iusto praesentium
                    reprehenderit temporibus? At beatae cum delectus dolor doloribus, eaque est nesciunt odit officiis,
                    pariatur quaerat quibusdam, quis quo repellat repudiandae sapiente soluta! Atque, aut culpa
                    cupiditate ea eius harum inventore laudantium mollitia natus officia omnis optio perferendis
                    recusandae repellat, tempore. Aliquam aliquid amet, animi architecto asperiores aspernatur, aut
                    autem commodi delectus distinctio dolorum eius esse explicabo incidunt iure iusto minima mollitia
                    natus nemo officia officiis perspiciatis porro praesentium quia quo repellendus voluptates! Expedita
                    explicabo inventore magni quis voluptate?</p>
            </div>
