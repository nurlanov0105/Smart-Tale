...
const ResumeForm: FC = () => {
   ...
   const { register, handleSubmit, isLoading, isError, isValid, control, errors } = useAddResume();
   console.log(isValid);
